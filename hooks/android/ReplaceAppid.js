...
const constants={
    ...
    pluginID : path.join("com","outsystems","uaepass")
}
...
module.exports = function (context) {
    ...
    var pathArray = [path.join(constants.javaSrcPath,constants.pluginID,"UAEPassRequestModels.java"),
                    path.join(constants.javaSrcPath,constants.pluginID,"UAEPass.java")]
